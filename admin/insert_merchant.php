...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index.php" class="active"><i class="fa fa-circle-o"></i> List User</a></li>
            <li class="active"><a href="list_promo.php"><i class="fa fa-circle-o"></i> List Promo</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">	
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>Insert Merchants</small>
      </h1>

<!-- .wrapper -->
<div class="box">
    <div class="box-header">
        <h3 class="box-title">Insert Data for Merchants</h3>
   </div>
   <div class="box-header">
...
<form action="controllers/doAddMerchant.php" method="POST">
  <div class="container" style="padding-left: 25%">
    <div class="form-group">  
       <div class="well col-md-7">
          <div class="form-group">
            <label for="nama">Merchant Name:</label>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="merchant_product" placeholder="Merchant Product">
          </div>
        <div>
          <?php
