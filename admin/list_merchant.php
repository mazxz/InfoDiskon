...
<div class="wrapper">
  ...
  <div class="content-wrapper">	
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>List Merchants</small>
      </h1>
  <div class="box">
    <div class="box-header">
        <h3 class="box-title">Data Table for Merchants</h3>
   </div>
     <div class="box-header">
     	<a href="insert_merchant.php"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add New</button></a>
     </div>
   <!-- /.box-header -->
	<div class="box-body">
	  		...
	  		<table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
	    		<thead>
	    			<tr role="row">
	    				...
	    				<th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column descending" style="width: 77px;" aria-sort="ascending">Merchant ID</th>

	    				<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 101px;">Merchant Name</th>

	    				<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 86px;">Category
	    				</th>

	    				<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 86px;">Product
	    				</th>
        		...
        		<?php 
        			include '../controllers/connect.php';
					$query = "SELECT * FROM tbl_master_merchant";
					$execute = mysql_query($query) or trigger_error(mysql_error().$query);
        			$no=1;
        			...
        			{	
        				...
        				else
        				{
        					echo "<tr role='row' class='odd'>";
	        					...
	        					echo "<td>$no</td>";
	        					echo "<td>$data[merchantID]</td>";
	        					echo "<td>$data[merchant_name]</td>";
	        					echo "<td>$data[merchant_category]</td>";
	        					echo "<td>$data[merchant_product]</td>";
	        					echo "<td>$data[lastUpdate]</td>";
	        					echo "<td>$data[lastUpdateBy]</td>";
	        					echo "<td>$data[createdBy]</td>";
	        					echo "<td><a href='update_merchant.php?merchantID=".$data['merchantID']."'><button type='button' class='btn btn-warning btn-xs'><span class='glyphicon glyphicon-edit'></span> Update&nbsp&nbsp</button></a>
					                  <a href='controllers/doDeleteMerchant.php?merchantID=".$data['merchantID']."' onclick='return konfirmasi()'><button type='button' class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-trash'></span> Delete</button></a></td>";
					            echo "</tr>";
