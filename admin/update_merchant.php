...
<?php 
          include '../controllers/connect.php';
          $query = "SELECT * FROM tbl_master_merchant WHERE merchantID = '$id'";
...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">Update Data for Merchants</h3>
   </div>
   <div class="box-header">
      <a href="list_merchant.php"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancel</button></a>
     </div> 
<h2 style="padding-left: 43%">Merchant Data</h2> 
<form action="controllers/doUpdateMerchant.php" method="POST">
    ...
    <div class="form-group">  
       <div class="well col-md-7">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="merchant_name" placeholder="Nama" value="<?php echo $data['merchant_name'] ?>">
          </div>
          <div class="form-group">
            <label for="merchant_category">Category:</label>
            <select name="merchant_category" class="form-control">
            	<option value="<?php echo $data['merchant_category'] ?>"><?php echo $data['merchant_category'] ?></option>
            </select>
          </div>
          <div class="form-group">
            <label for="username">Product:</label>
            <input type="text" class="form-control" name="merchant_product" placeholder="Product" value="<?php echo $data['merchant_product'] ?>">
          </div>
          <div>
          <?php
