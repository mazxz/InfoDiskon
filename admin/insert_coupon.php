...
<div class="wrapper">
  ...
  <div class="content-wrapper">	
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>Insert Coupons</small>
      </h1>

<!-- .wrapper -->
<div class="box">
    <div class="box-header">
        <h3 class="box-title">Insert Data for Coupons</h3>
   </div>
   <div class="box-header">
...
<form action="controllers/doAddCoupon.php" method="POST">
    ...
    <div class="form-group">  
       <div class="well col-md-7">
          ...
          <div class="form-group">
            ...
            <textarea name="coupon_desc" class="form-control" rows="3" placeholder="Description"></textarea>
          </div>
        <div>
          <?php
