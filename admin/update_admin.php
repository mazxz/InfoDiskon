...
<?php 
          include '../controllers/connect.php';
          $query = "SELECT * FROM tbl_master_admin WHERE adminID = '$id'";
...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">Update Data for Admin</h3>
   </div>
   <div class="box-header">
      <a href="index.php"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancel</button></a>
     </div> 
<h2 style="padding-left: 43%">Admin Data</h2> 
<form action="controllers/doUpdateAdmin.php" method="POST">
    ...
    <div class="form-group">  
       <div class="well col-md-7">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="nama_admin" placeholder="Nama" value="<?php echo $data['nama_admin'] ?>">
          </div>
          <div class="form-group">
