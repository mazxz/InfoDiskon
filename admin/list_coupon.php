...
<head>
  ...
  <!-- Sweet Alert Script -->x
  <link rel="stylesheet" type="text/css" href="dist/js/sweetalert.css">
...
<div class="wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>List Coupons</small>
      </h1>
  <div class="box">
    <div class="box-header">
        <h3 class="box-title">Data Table for Coupons</h3>
   </div>
     <div class="box-header">
      <a href="insert_coupon.php"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add New</button></a>
     </div>
   <!-- /.box-header -->
  <div class="box-body">
        ...
        <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
          <thead>
            <tr role="row">
              ...
              <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column descending" style="width: 77px;" aria-sort="ascending">Coupon ID</th>

              <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 101px;">Coupon Code</th>
            ...
            <?php 
              include '../controllers/connect.php';
          $query = "SELECT * FROM tbl_master_coupon";
          $execute = mysql_query($query) or trigger_error(mysql_error().$query);
              $no=1;
              ...
              { 
                ...
                else
                {
                  echo "<tr role='row' class='odd'>";
                    ...
                    echo "<td>$no</td>";
                    echo "<td>$data[couponID]</td>";
                    echo "<td>$data[coupon_code]</td>";
                    echo "<td>$data[coupon_description]</td>";
                    echo "<td>$data[lastUpdate]</td>";
                    echo "<td>$data[lastUpdateBy]</td>";
                    echo "<td>$data[createdBy]</td>";
                    echo "<td><a href='update_coupon.php?couponID=".$data['couponID']."'><button type='button' class='btn btn-warning btn-xs'><span class='glyphicon glyphicon-edit'></span> Update&nbsp&nbsp</button></a>
                            <a href='controllers/doDeleteCoupon.php?couponID=".$data['couponID']."' onclick='return konfirmasi()'><button type='button' class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-trash'></span> Delete</button></a></td>";
                      echo "</tr>";
