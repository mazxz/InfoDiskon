...
<?php 
          include '../controllers/connect.php';
          $query = "SELECT * FROM tbl_master_coupon WHERE couponID = '$id'";
...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">Update Data for Coupons</h3>
   </div>
   <div class="box-header">
      <a href="list_coupon.php"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancel</button></a>
     </div> 
<h2 style="padding-left: 43%">Coupon Data</h2> 
<form action="controllers/doUpdateCoupon.php" method="POST">
<input type="hidden" name="couponID" value="<?php echo $data['couponID'];?>">
  <div class="container" style="padding-left: 25%">
    <div class="form-group">  
       <div class="well col-md-7">
          <div class="form-group">
            <label for="coupon_code">Coupon Code:</label>
            <input type="text" class="form-control" name="coupon_code" placeholder="Coupon Code" value="<?php echo $data['coupon_code'] ?>">
          </div>
          <div class="form-group">
            <label for="coupon_desc">Description:</label>
            <textarea name="coupon_desc" class="form-control" rows="3"><?php echo $data['coupon_description']; ?></textarea>
          </div>
          <div>
          <?php
